...
type WindowWrapperWithSidebarProps = {
...
const WindowWrapperWithSidebar = ({
  windowId,
  sidebar,
  children,
  onClose,
  ...
  return (
    <Rnd
      ...
      dragHandleClassName="c-windowWrapperWithSidebar__sideBar_header"
      enableResizing={disableResizing || isMaximized ? false : true}
      disableDragging={isMaximized}
      cancel=".c-windowWrapperWithSidebar__titleBar_buttons"
    ...
    >
      <section
        ...
        className={`c-windowWrapperWithSidebar ${className} ${isClosing ? "closed" : ""} ${isMaximized ? "maximized" : ""} ${isFocused ? "focused" : "unfocused"} ${isMinimizing || isMinimized ? "minimizing" : ""} ${isRestoring ? "restoring" : ""}`}
        style={minimizeStyle}
      >
...
export default WindowWrapperWithSidebar;
